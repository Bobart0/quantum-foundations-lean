...
1. **Théorème de dilation de Naimark** (POVM finie à m issues sur ℂⁿ) — EN COURS
2. Théorème de Wigner — après Naimark, plan à venir.
...
- **Paris**, *The modern tools of quantum mechanics* (2012), §3.2, Theorem 4
  ...
  construction passe par l'égalité des dimensions des orthocompléments.
  Version unitaire = jalon N5 OPTIONNEL, pas le cœur v1.
...
## Ordre d'attaque Naimark (détail et suivi dans SORRIES.md)
- **N0** squelette : POVM, DilSpace, énoncés en sorry, Nonvacuity, CI — build vert
...
- **N5** (OPTIONNEL) version unitaire/ancilla — nécessite le lemme d'extension
  d'isométrie partielle en unitaire (candidat Mathlib)

## Git
- Branche `main`, commits atomiques, messages `feat|fix|chore(scope): ...`
