# AGENTS.md — quantum-foundations-lean
...
2. **Théorème de Wigner** — ✅ TERMINÉ (2026-07-13, W0–W5 tous clos, 0 sorry, 0
   ...
   dérivations, écarts signalés et résolus) dans MILESTONES.md, section « Wigner ».
...
- **Paris**, *The modern tools of quantum mechanics* (2012), §3.2, Theorem 4
  ...
  initialement envisagée (timeout Lean, voir MILESTONES.md) — route finale : deux
...
## Ordre d'attaque Naimark — TERMINÉ (détail et historique dans MILESTONES.md)
...
- **N5** (optionnel) version unitaire/ancilla — ✅ (3 tentatives, voir MILESTONES.md
...
2. Wigner's theorem — ✅ COMPLETE (2026-07-13, W0–W5 all closed, 0 sorry, 0
 ...
 derivations, documented and resolved deviations) is in MILESTONES.md, section
...
- Paris, The modern tools of quantum mechanics (2012), §3.2, Theorem 4
 ...
 by the initially proposed Submodule approach (Lean timeout; see MILESTONES.md).
...
## Naimark implementation order — COMPLETE (details and history in MILESTONES.md)
...
- N5 (optional) unitary/ancilla version — ✅ (three attempts; see MILESTONES.md
