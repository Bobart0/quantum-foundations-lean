...
/-!
# AFM publication audit

This file is the exact QuantumFoundations-side audit surface for the
Annals of Formalized Mathematics manuscript on finite-dimensional quantum
probability and symmetry.  It does not prove new mathematics.  It checks the
public signatures used by the article and asks Lean to report the axiom
